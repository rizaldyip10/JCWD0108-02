import { Box, Button, Flex, Input, Select, Table, TableContainer, Tbody, Td, Text, Th, Thead, Tr, useDisclosure } from "@chakra-ui/react"
...
export const CashierTrans = ({ reload, setReload }) => {
    ...
    return (
        <Flex p={10} bg="white" justifyContent="center" direction="column">
